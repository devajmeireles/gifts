        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex justify-end">
            ...
            <span>
                ...
                @if ($paginator->hasMorePages())
                    ...
                    @endif
                @else
                    <span class="relative inline-flex items-center px-4 py-2 ml-3 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-md select-none dark:bg-gray-700 dark:border-gray-700 dark:text-white">
                        {!! __('pagination.next') !!}
                    </span>
                @endif
            </span>
